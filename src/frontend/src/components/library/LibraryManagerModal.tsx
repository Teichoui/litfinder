...
export const LibraryManagerModal = ({ isOpen, onClose }: LibraryManagerModalProps) => {
  ...
  return (
    <div
      ...
      role="presentation"
    >
      <div className="relative mx-4 my-4 flex h-full max-h-[90vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-(--border-muted) bg-(--bg) shadow-2xl">
