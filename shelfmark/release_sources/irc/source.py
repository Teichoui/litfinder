...
class IRCReleaseSource(ReleaseSource):
    ...
    def search(
        ...
        *,
        ...
        # spam to everyone else and gets the nick banned. Searches must be addressed to
        # a search bot ("@<bot> <query>"). is_available() already enforces this, but we
        # guard here too as defense in depth.
        if not search_bot:
            logger.warning(
        ...
        try:
            ...
            # Always addressed to the search bot, never posted bare to the channel.
